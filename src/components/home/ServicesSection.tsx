        ...
        >
          ...
          <div className="col-span-12 lg:col-span-5 lg:col-start-8 flex items-end">
            <p className="text-sm sm:text-base text-muted-foreground font-light leading-relaxed">
              At NJ Macson, we offer a comprehensive range of advisory services
              designed to help you navigate the complexities of future
        ...
        <div className="space-y-1">
          {services.map((service, index) => (
            ...
            >
              <Link
                to={service.link}
                className={`grid grid-cols-12 gap-4 sm:gap-6 lg:gap-8 py-6 sm:py-8 lg:py-10 border-t border-stone/50 items-center ${
              ...
              >
                ...
                <div
                  className={`col-span-12 lg:col-span-5 ${
                    index % 2 === 0
                      ? "lg:order-3 lg:col-start-7"
                      : "lg:order-2 lg:col-start-3"
                  }`}
                >
                  <h3 className="font-serif text-xl sm:text-2xl md:text-3xl font-light mb-3 sm:mb-4 group-hover:text-primary transition-colors duration-300">
                    {service.title}
                  </h3>
                  <p className="text-sm sm:text-base text-muted-foreground font-light leading-relaxed mb-4 sm:mb-6 max-w-md">
                    {service.description}
                  </p>
                  <span className="inline-flex items-center gap-3 text-sm uppercase tracking-[0.12em] sm:tracking-[0.2em] group-hover:text-primary transition-colors">
                    Learn More
                    <svg
