...
const stats = [
  { value: "5", suffix: "+", label: "Countries", description: "Global Presence" },
  { value: "25", suffix: "+", label: "Key Markets", description: "Strategic Locations" },
  { value: "1,000", suffix: "+", label: "Affiliates", description: "Trusted Partners" },
];
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 relative z-10">
        ...
        >
          ...
          <p className="text-background/60 font-light text-lg max-w-xl mx-auto">
            Where wealth management meets opportunity
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-center py-8 px-6 transition-all duration-500 group-hover:bg-background/5 rounded-lg">
                {/* Large number */}
                <div className="relative mb-4">
                  <motion.span 
                    className="text-6xl md:text-7xl lg:text-8xl font-light text-primary tracking-tight"
                  ...
                  <span className="text-4xl md:text-5xl lg:text-6xl font-light text-primary/80">{stat.suffix}</span>
                </div>
                
                {/* Label */}
                <h3 className="text-xl md:text-2xl font-light text-background mb-2 tracking-wide">
                  {stat.label}
                </h3>
