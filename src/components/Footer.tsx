...
const services = [
  ...
  {
    to: "/services/private-wealth-management",
...
const Footer = () => {
  ...
  return (
    <footer className="mt-8 border-t border-stone bg-background sm:mt-10">
      <div className="mx-auto max-w-[1440px] px-4 py-12 sm:px-6 md:px-10">
        <div className="flex flex-col gap-12 lg:flex-row lg:justify-between lg:gap-16 xl:gap-24">
          <div className="lg:w-[34%]">
            ...
            <p className="mt-7 max-w-xl text-base font-light leading-tight text-foreground md:text-lg lg:text-xl">
              From basic finance guidance to family office services, we are
              here. <span className="font-bold">Plan for tomorrow, today..!</span>
            </p>
          </div>

          <nav className="lg:w-[20%]" aria-label="Footer services">
            <h5 className="mb-5 text-xs font-bold uppercase tracking-[0.28em] text-primary">
              Services
            </h5>
            <ul>
