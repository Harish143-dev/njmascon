...
const Hero = () => {
  return (
    <section className="max-w-[1440px] mx-auto px-6 md:px-10 min-h-screen flex">
        ...
        <div className="col-span-12 lg:col-span-5 order-2 lg:order-1">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-extralight leading-[1.1] tracking-tight">
              Legacy <br />
              <span className="italic font-light pl-6 md:pl-12 text-foreground/40">
                Architecture.
              </span>
            </h1>
            ...
            <div className="pt-8 flex flex-col sm:flex-row items-start sm:items-center gap-6">
              ...
              <a
                className="text-xs uppercase tracking-widest border-b border-primary/20 pb-1 hover:border-primary transition-all"
                href="#vision"
              >
                Discover more
              </a>
